...
define( "RECIPIENT_NAME", "Emanuel Arroyo" );
define( "RECIPIENT_EMAIL", "emanuelarroyodev@gmail.com" );
...
if ( $senderName && $senderEmail && $senderPhone && $subject && $message) {
  ...
  echo "<script>alert('Your message has been successfully submitted Thanks. 🙂');</script>";
