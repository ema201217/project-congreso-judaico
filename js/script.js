  ...
  if ($(".cs-countdown").length) {
    ...
    $(".cs-countdown")
      ...
      .on("update.countdown", function (event) {
        var $this = $(this).html(
          event.strftime(
            "<div><span>%m</span><h6>Meses</h6></div> <div><span>%D</span><h6>días</h6></div> <div><span>%H</span><h6>Horas</h6></div> <div><span>%M</span><h6>Minutos</h6></div> <div><span>%S</span><h6>Segundos</h6></div>"
          )
        );
      });
  }
